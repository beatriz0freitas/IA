...
class ComponentesUI:
    ...
    # CONFIGURAÇÃO DA SIMULAÇÃO - DETALHADA
    ...
    # PEDIDOS ATIVOS - LISTA EXPLICITA    
    def criar_pedidos_lista(self, container) -> dict:
        """Lista de pedidos ativos com detalhes."""
        frame = tk.Frame(container, bg="#ffffff")
        frame.pack(fill="x", padx=12, pady=(0, 8))
        ...
        canvas = tk.Canvas(frame, bg="#f9fafb", highlightthickness=0, height=100)
    ...
    def criar_card_pedido(self, container, pedido) -> tk.Frame:
        """Cria card compacto e explícito para pedido."""
